...
export default function MapModalView(props) {
  return (
    <>
            ...
            <div className="flex min-h-full items-center justify-center text-center">
              ...
              >
                <Dialog.Panel className="w-full h-full max-h-lg max-w-lg transform overflow-hidden rounded-lg border-brand-blue border-2 bg-white text-left align-middle shadow-xl transition-all">
                  ...
                  <Dialog.Title
                    as="h3"
                    className="text-lg left-10 font-medium leading-6 text-gray-900 border-b-2 border-brand-blue mt-2 mb-4 align-self: center"
                  >
                    Find Location
                  </Dialog.Title>
                  <div className="ml-14 mb-4 mr-14">
                    <SimpleMap />
                  </div>
                </Dialog.Panel>
              </Transition.Child>
