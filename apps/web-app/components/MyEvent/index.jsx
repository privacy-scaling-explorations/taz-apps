const MyEvents = () => (
    <div className="mx-6 my-8">
        <div>
            <h1 className="relative inline-block bg-black mb-12 text-xl text-brand-beige2">TAZ</h1>
        </div>
        <div>
            ...
            <div className="flex-grow text-brand-brown p-4 min-w-[200px] min-h-[100%] relative divide-y overflow-y-auto border-2 border-brand-blue rounded-md bg-white drop-shadow-lg">
                ...
                <div className="grid grid-cols-6 py-5 gap-5">
                    <div className="h-[150px] flex flex-col justify-between">
                        ...
                        <div>
                            <button className="w-full bg-brand-yellow ring-2 rounded-b-md ring-brand-black py-3 px-4 drop-shadow text-brand-button font-medium text-brand-black hover:text-black focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange focus-visible:ring-opacity-25">Go to event</button>
                        </div>
