...
function ExperiencesListComponent({ clearIdentity, urlIdentity, initiateSignInModal, signInModal, closeSignInModal, userLoggedIn, userSignOut, checkSession }) {
  ...
  return (
    ...
    <div className="grid">
      ...
      <div className="z-10 col-start-1 row-start-1 text-brand-brown">
        ...
        {!userLoggedIn ? <div className="relative flex flex-col items-center overflow-hidden mx-6 my-8 rounded-md border-2 border-brand-blue shadow-xl bg-white mb-8">
          <div className="flex w-full justify-between border-b-2 border-brand-blue bg-brand-beige2 p-3">
            <div>✌️</div>
            <div className="text-brand-blue text-15px">
              Checkout the events at Zuzalu
            </div>
            <div></div>
          </div>
          <Link href="events">
        ...
        </div> : <><div className="relative flex flex-col items-center overflow-hidden mx-6 my-8 rounded-md border-2 border-brand-blue shadow-xl bg-white mb-8">
            <div className="flex w-full justify-between border-b-2 border-brand-blue bg-brand-beige2 p-3">
            ...
            </div><div className=" relative flex flex-col items-center overflow-hidden mx-6 my-8 rounded-md border-2 border-brand-blue shadow-xl bg-white mb-16">
              <div className="flex w-full justify-between border-b-2 border-brand-blue bg-brand-beige2 p-3">
                <div>🌍</div>
                <div className="text-15px text-brand-blue">
        ...
        <div className="relative flex items-left flex-col bg-black text-brand-yellow pt-8 mt-12">
          <div className="py-10 px-14 flex items-end justify-between bg-black">
            <div className="transform -ml-6 text-xl tracking-widest text-brand-beige">
              <h1>TEMP_RARY</h1>
              <h1 className="bg-brand-beige px-1 text-brand-black">
                AN_NYMOUS
              </h1>
              <h1>Z_NE</h1>
            </div>
          ...
          <p className="pl-9 ml-12 mb-5 text-brand-info">
            <span>
              <button
                onClick={goToTop}
                className="text-brand-info underline cursor-pointer"
              >
                Save ID
              </button>
            </span>{" "}
