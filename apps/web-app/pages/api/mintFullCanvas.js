    ...
    if (res.method === "GET") {
        ...
        try {
            ...
            if (
                ...
                res.status(400).json(
                    "Needs to have imageUri, canvasId, groupId, signal, nullifierHash, externalNullifier, solidityProof"
                )
            }
            ...
            const obj = {
                ...
                image: imageUrl,
                description: "Art generated collaboratively and anonymously through the TAZ app at Devcon VI in Bogotá",
                attributes: [
                    {
                        event: "DEVCON VI"
                    }
