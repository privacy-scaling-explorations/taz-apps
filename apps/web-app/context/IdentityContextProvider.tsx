...
const [useIdentityLoginContext, IdentityLoginContext] = contextFactory<(value: Identity) => void>()
...
export function IdentityContextProvider({ children }: IdentityContextProviderProps) {
