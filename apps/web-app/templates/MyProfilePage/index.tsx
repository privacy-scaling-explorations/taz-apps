        ...
        <div className="flex flex-col bg-[#EEEEF0] px-[24px] py-[24px] gap-[16px]">
            <div className="flex justify-between p-5 bg-white w-full rounded-[8px]">
                ...
                <div className="flex justify-center items-center">
                    <button className="text-[#F8FFFE] bg-[#35655F] rounded-[8px] flex flex-row justify-center items-center py-[8px] px-[16px] flex flex-row gap-[8px]">
            ...
            <div className="flex justify-between h-[100vh]">
                <div className="p-5 flex flex-col items-start bg-white rounded-[8px] w-4/6 gap-10">
                ...
                <div className="flex flex-col pl-5 w-2/6 gap-10">
