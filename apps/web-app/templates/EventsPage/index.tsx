...
function sliceIntoChunks(arr: EventsDTO[], chunkSize: number) {
    const res = []
...
const EventsPage = ({ events }: Props) => {
    const slicedEvents = sliceIntoChunks(events, 5)
                ...
                <div className="w-full h-full flex justify-between lg:flex-row flex-col py-5 px-[48px] bg-white rounded-[16px] gap-5 lg:gap-0">
                    ...
                    <div className="flex flex-col lg:w-3/6 w-full justify-between">
                        ...
                        <h1 className="text-[21px]">
                            Join 200 core residents for healthy living, co-working and learning through co-created
                            events on synthetic biology, ZK, public goods, longevity, and network states.
                        </h1>
                    </div>
                ...
                <div className="flex flex-col bg-white p-5 rounded-[8px] gap-10">
                    ...
                    <div className="grid grid-cols-1 w-full gap-5 md:grid-cols-2">
                        <div className="grid grid-cols-2 gap-5">
                            <div className="flex flex-col gap-5 md:gap-2 justify-center md:justify-start col-span-2 p-[32px] bg-[url('/event-image-2.png')] h-[250px] bg-cover bg-no-repeat bg-center rounded-[16px]">
                            ...
                            <div className="flex flex-col gap-5 md:gap-2 justify-center md:justify-start p-[32px] bg-[url('/event-image-2.png')] h-[250px] bg-cover bg-no-repeat bg-center rounded-[16px]">
                        ...
                        <div className="grid grid-cols-2 gap-5">
                            ...
                            <div className="flex flex-col gap-5 md:gap-2 justify-center md:justify-start md:p-[32px] p-[12px] w-full bg-[url('/event-image-2.png')] h-[250px] bg-cover bg-no-repeat bg-center rounded-[16px]">
                            ...
                            <div className="flex flex-col gap-5 md:gap-2 justify-center md:justify-start col-span-2 md:p-[32px] p-[23px] bg-[url('/event-image-2.png')] h-[250px] bg-cover bg-no-repeat bg-center rounded-[16px]">
